  ...
  return (
    <>
      <section className='home crew px-5 h-full'>  
        ...
        <div className=' flex items-center justify-center flex-col-reverse md:top-1/2 mt-4 md:mt-0 md:relative md:-translate-y-1/2 md:pt-20 md:grid md:grid-cols-2 md:gap-5 md:items-center lg:max-w-6xl lg:mx-auto'>

          <article className='text-center md:text-left md:mt-0 sm:mt-44'>

            

            <h2 className='text-3xl md:text-3xl font-bold text-white mt-4 mb-4 md:mx-2 uppercase tracking-widest'>
              {name}
            </h2>
